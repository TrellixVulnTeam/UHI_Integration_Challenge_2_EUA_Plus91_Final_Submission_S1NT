  ...
  (self["webpackChunkphoto_gallery_ng_capacitor"] = self["webpackChunkphoto_gallery_ng_capacitor"] || []).push([["src_app_pages_dashboard_search-results_search-results_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "SearchResultsPageRoutingModule": function SearchResultsPageRoutingModule() {
          return (
            /* binding */
            _SearchResultsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _search_results_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./search-results.page */
      84399);
      /* harmony import */
      ...
      var _SearchResultsPageRoutingModule = function _SearchResultsPageRoutingModule() {
        _classCallCheck(this, _SearchResultsPageRoutingModule);
      };

      _SearchResultsPageRoutingModule.ɵfac = function SearchResultsPageRoutingModule_Factory(t) {
        return new (t || _SearchResultsPageRoutingModule)();
      };

      _SearchResultsPageRoutingModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: _SearchResultsPageRoutingModule
      });
      _SearchResultsPageRoutingModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](_SearchResultsPageRoutingModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "SearchResultsPageModule": function SearchResultsPageModule() {
          return (
            /* binding */
            _SearchResultsPageModule
          );
        }
        /* harmony export */
      ...
      var _search_results_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./search-results-routing.module */
      41217);
      /* harmony import */


      var _search_results_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./search-results.page */
      84399);
      /* harmony import */
      ...
      var _SearchResultsPageModule = function _SearchResultsPageModule() {
        _classCallCheck(this, _SearchResultsPageModule);
      };

      _SearchResultsPageModule.ɵfac = function SearchResultsPageModule_Factory(t) {
        return new (t || _SearchResultsPageModule)();
      };

      _SearchResultsPageModule.ɵmod = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: _SearchResultsPageModule
      });
      _SearchResultsPageModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.IonicModule, _search_results_routing_module__WEBPACK_IMPORTED_MODULE_0__.SearchResultsPageRoutingModule]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](_SearchResultsPageModule, {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function SearchResultsPage_div_10_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SearchResultsPage_div_11_div_1_br_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "br");
        }
      }

      function SearchResultsPage_div_11_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function SearchResultsPage_div_11_div_1_Template_ion_chip_click_21_listener() {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r7);

            var i_r4 = restoredCtx.index;
            var fulfillment_r3 = restoredCtx.$implicit;

            var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](2);

            return ctx_r6.book_appointment(i_r4, fulfillment_r3);
          });
        ...
        if (rf & 2) {
          var fulfillment_r3 = ctx.$implicit;
      ...
      function SearchResultsPage_div_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _SearchResultsPage = /*#__PURE__*/function () {
        function _SearchResultsPage(_router, _api, _commonService) {
          _classCallCheck(this, _SearchResultsPage);
        ...
        _createClass(_SearchResultsPage, [{
          key: "ngOnInit",
          ...
          value: function book_appointment(index, data) {
            this._commonService.presentLoading(1000); // console.log(index);
      ...
      _SearchResultsPage.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        type: _SearchResultsPage,
        selectors: [["app-search-results"]],
        decls: 12,
        vars: 4,
        consts: [[3, "translucent"], ["slot", "start"], ["slot", "secondary"], ["defaultHref", "/dashboard/home"], [3, "fullscreen"], [1, "container-fluid", "w-100", "h-100", "p-3"], ["class", "col-12 text-center", 4, "ngIf"], ["class", "d-block w-100 h-100", 4, "ngIf"], [1, "col-12", "text-center"], [1, "d-block", "w-100", "h-100"], ["class", "d-block col-12", 4, "ngFor", "ngForOf"], [1, "d-block", "col-12"], [1, "m-0", "p-0", "mb-3"], [1, "border-0"], [1, "h-100", 2, "padding-top", "5px", "padding-bottom", "5px"], ["alt", "", 2, "width", "60px", "margin", "5px 15px 5px 0px", "border-radius", "100%", 3, "src"], [1, "text-muted", "fs-14"], [2, "color", "#3880ff"], [4, "ngIf"], [1, "m-0", "p-2"], [1, "d-flex", "flex-wrap", "justify-content-start"], ["outline", "", "color", "primary", 3, "click"], [2, "color", "red", "font-size", "16px", "font-weight", "700"], [2, "font-size", "12px", "font-weight", "600", "margin-left", "10px", "color", "var(--ion-color-primary)"]],
        template: function SearchResultsPage_Template(rf, ctx) {
          if (rf & 1) {
...
//# sourceMappingURL=src_app_pages_dashboard_search-results_search-results_module_ts-es5.js.map