(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),require('@angular/common'),exports, require('@angular/common/http'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-typeahead', ['@angular/core','@angular/common/http','@angular/common','exports', '@angular/common/http', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common.http,global.ng.common,global['ngx-typeahead'] = {}, global.ng.common.http, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, http, core, rxjs, operators, common) { 
    ...
    */
    var NgxTypeAheadComponent = /** @class */ (function () {
        ...
        NgxTypeAheadComponent.prototype.navigateWithArrows = function (elementObs) {
            var _this = this;
            elementObs
                .pipe(operators.map(function (e) { return e.key; }), operators.filter(function (key) { return validateArrowKeys(key); }))
...
NgxTypeaheadModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[common.CommonModule, http.HttpClientModule, http.HttpClientJsonpModule], ɵngcc2.CommonModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxTypeaheadModule, { declarations: [NgxTypeAheadComponent], imports: [ɵngcc2.CommonModule, ɵngcc1.HttpClientModule, ɵngcc1.HttpClientJsonpModule], exports: [NgxTypeAheadComponent, ɵngcc2.CommonModule] }); })();
